...
static constexpr auto qt_meta_stringdata_ZN12OptionDialogE = QtMocHelpers::stringData(
    "OptionDialog",
    "onOption1Changed",
    "",
    "state"
...
Q_CONSTINIT static const uint qt_meta_data_ZN12OptionDialogE[] = {
...
Q_CONSTINIT const QMetaObject OptionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12OptionDialogE.offsetsAndSizes,
    qt_meta_data_ZN12OptionDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12OptionDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OptionDialog, std::true_type>,
        // method 'onOption1Changed'
...
void OptionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onOption1Changed((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *OptionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12OptionDialogE.stringdata0))
