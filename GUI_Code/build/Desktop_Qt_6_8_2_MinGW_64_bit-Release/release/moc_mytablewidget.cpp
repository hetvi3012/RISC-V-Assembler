...
static constexpr auto qt_meta_stringdata_ZN13MyTableWidgetE = QtMocHelpers::stringData(
    "MyTableWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MyTableWidgetE[] = {
...
Q_CONSTINIT const QMetaObject MyTableWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MyTableWidgetE.offsetsAndSizes,
    qt_meta_data_ZN13MyTableWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MyTableWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyTableWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MyTableWidgetE.stringdata0))
