...
static constexpr auto qt_meta_stringdata_ZN9simWindowE = QtMocHelpers::stringData(
    "simWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9simWindowE[] = {
...
Q_CONSTINIT const QMetaObject simWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9simWindowE.offsetsAndSizes,
    qt_meta_data_ZN9simWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9simWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *simWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9simWindowE.stringdata0))
